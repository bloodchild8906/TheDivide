...
namespace DuloGames.UI
{
	...
	public class UISelectField : Toggle
    {
		...
		[Serializable] public class TransitionEvent : UnityEvent<VisualState, bool> { }
		...
		{
			if (this.animator == null || !this.animator.enabled || !this.animator.hasBoundPlayables || !this.animator.isActiveAndEnabled || this.animator.runtimeAnimatorController == null || string.IsNullOrEmpty(trigger))
				return;
        ...
        protected void CreateList()
        {
            ...
            if (this.allowScrollRect && this.m_Options.Count >= this.scrollMinOptions)
            {
                ...
                // Add scroll rect
                this.m_ScrollRect = this.m_ListObject.AddComponent<ScrollRect>();
                ...
                viewPortGo.transform.SetParent(rect, false);
                ...
                {
                    GameObject scrollBarGo = Instantiate(this.scrollBarPrefab, this.m_ListObject.transform);
        ...
        protected virtual void ScrollContentDimensionsChanged()
        {
            ...
            float viewHeight = (this.m_ScrollRect.transform as RectTransform).sizeDelta.y;
